...
const PatientTable = ({ 
  ...
  const renderPaginationControls = () => {
    ...
    if ((pagination.total ?? 0) <= (pagination.per_page || CONFIG.ui.defaultPageSize)) {
      return null;
    }
                    ...
                    <td>
                      <button
                        ...
                        style={{
                          fontWeight: 'normal',
                          color: '#007bff',
                          cursor: (!patient.id || patient.id === 'Unknown') ? 'not-allowed' : 'pointer'
                        }}
                        onMouseEnter={(e) => {
                      ...
                      <div className="patient-link-sub">
                        {patient.id && patient.id !== 'Unknown' ? 'Click to view details' : 'No ID available'}
                      </div>
                    </td>
